...
const extendedPostsData = [
  // React 核心文章
  {
    ...
    excerpt: "深入理解 React 18 的并发特性，通过实际案例学习如何使用 useTransition 和 useDeferredValue 优化用户体验。",
    date: "2024-02-15",
    author: "冯行",
    category: "React 进阶",
  ...
  },
  {
    ...
    excerpt: "探索 TypeScript 的高级类型，实现条件类型、映射类型和递归类型，打造类型安全的 React 应用。",
    date: "2024-02-10",
    author: "冯行",
    category: "TypeScript",
  ...
  },
  {
    ...
    excerpt: "从架构设计到实际应用，全面解析 Next.js 14 的服务端组件模式，以及如何在项目中合理使用。",
    date: "2024-02-05",
    author: "冯行",
    category: "Next.js",
  ...
  },
  {
    ...
    excerpt: "深入 React 渲染机制，掌握 memo、useMemo、useCallback 的正确使用姿势，告别不必要的重渲染。",
    date: "2024-01-28",
    author: "冯行",
    category: "性能优化",
    tags: ["性能优化", "渲染", "最佳实践"],
  ...
  },
  {
    ...
    excerpt: "通过手写实现 useState、useEffect 等核心 Hooks，深入理解 Fiber 架构和 Hook 的工作原理。",
    date: "2024-01-20",
    author: "冯行",
    category: "React 源码",
  ...
  },
  {
    ...
    excerpt: "深入对比 Zustand、Redux Toolkit、Jotai 等状态管理库，帮你选择最适合项目的方案。",
    date: "2024-01-12",
    author: "冯行",
    category: "状态管理",
  ...
  },
  {
    ...
    excerpt: "结合 React 和 TailwindCSS，学习如何设计原子化的组件系统，提升开发效率和一致性。",
    date: "2024-01-05",
    author: "冯行",
    category: "CSS",
  ...
  },
  {
    ...
    excerpt: "使用 Jest、React Testing Library 和 Cypress，构建完整的 React 应用测试体系。",
    date: "2023-12-28",
    author: "冯行",
    category: "测试",
  ...
  },
  {
    ...
    excerpt: "掌握 Framer Motion 的核心概念，为 React 应用添加流畅自然的交互动画效果。",
    date: "2023-12-20",
    author: "冯行",
    category: "动画",
  ...
  },
  {
    ...
    excerpt: "探讨 React 项目中的架构设计模式，包括容器组件、高阶组件、Render Props 等。",
    date: "2023-12-12",
    author: "冯行",
    category: "架构设计",
    tags: ["设计模式", "架构", "最佳实践"],
...
// 动漫风格数据
const animeThemes = [
  { emoji: "⚛️", name: "React", color: "from-blue-400 to-cyan-400", bg: "bg-blue-50" },
  { emoji: "📘", name: "TypeScript", color: "from-blue-500 to-indigo-500", bg: "bg-blue-50" },
  { emoji: "▲", name: "Next.js", color: "from-gray-800 to-gray-600", bg: "bg-gray-50" },
  { emoji: "🎨", name: "Tailwind", color: "from-cyan-400 to-teal-400", bg: "bg-cyan-50" },
  { emoji: "📦", name: "Zustand", color: "from-amber-400 to-orange-400", bg: "bg-amber-50" },
...
const Home = () => {
  ...
  // 排除特色文章
  const regularPosts = extendedPostsData.filter(post => 
  ...
  return (
    <div className="min-h-screen bg-[#0B0F1C] text-white relative overflow-x-hidden">
      ...
      <div className="relative z-10">
        {/* 顶部导航装饰 */}
        {/* <div className="bg-[#1A1F2E] border-b border-[#4FD1C5]/20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-3">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4 text-sm text-gray-400">
                <span className="hover:text-[#4FD1C5] cursor-pointer transition">React</span>
                ...
                <span className="hover:text-[#4FD1C5] cursor-pointer transition">源码</span>
              </div>
            </div>
          </div>
        </div> */}
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center space-x-2">
                            {post.tags.slice(0, 2).map((tag, i) => (
                              <span key={i} className="text-xs text-[#4FD1C5]">#{tag}</span>
                            ))}
                          </div>
                        </div>
                      </div>
              ...
              <div className="bg-[#1A1F2E] rounded-xl p-6 border border-[#4FD1C5]/10">
                ...
                <div className="flex flex-wrap gap-2">
                  {["React", "TypeScript", "Next.js", "性能优化", "源码", "Hooks", "状态管理", "动画", "测试", "架构"].map((tag, i) => (
                    <span key={i} className="px-3 py-1 bg-[#2A2F3E] text-gray-300 text-sm rounded-full hover:bg-[#4FD1C5] hover:text-[#0B0F1C] cursor-pointer transition">
                      #{tag}
                    </span>
                  ))}
                </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
              ...
              <div className="flex items-center space-x-4 mt-4 md:mt-0">
                <span className="hover:text-[#4FD1C5] cursor-pointer">⚛️ React</span>
                <span className="hover:text-[#4FD1C5] cursor-pointer">📘 TypeScript</span>
                <span className="hover:text-[#4FD1C5] cursor-pointer">▲ Next.js</span>
              </div>
            </div>
          </div>
        </footer>
